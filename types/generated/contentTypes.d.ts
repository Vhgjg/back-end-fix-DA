...
export interface ApiAnggotaAnggota extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    Sie: Schema.Attribute.Enumeration<
      ['Pengurus harian', 'Teknik Kepramukaan', 'Evaluasi']
    >;
...
export interface ApiBeritaBerita extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Isi_Berita: Schema.Attribute.Text & Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::anggota.anggota': ApiAnggotaAnggota;
